...
using NDbUnit.Core.SqliteMicrosoftData;
using NDbUnit.Core;
...
namespace NDbUnit.Test.SqliteMicrosoftData
{
    ...
    [TestFixture]
    class SqliteMsDataCommandBuilderTest : NDbUnit.Test.Common.DbCommandBuilderTestBase
    {
        ...
        {
            var connectionManager = new DbConnectionManager<SqliteConnection>(DbConnections.SqliteMsDataConnectionString);
            return new DisposableDbCommandBuilder<SqliteConnection>(
                connectionManager, new SqliteMsDataDbCommandBuilder(connectionManager));
        }
